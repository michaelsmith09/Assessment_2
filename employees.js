...
//CODE HERE
var empTwo = { ...empOne };    //spread operator
// var empTwo = Object.assign({}, empOne)
// var empTwo = JSON.parse(JSON.stringify(empOne))
empTwo.name = 'Nick'; 
...
//CODE HERE
var manager = new Manager ('Winston', 'weekday mornings, weekday afternoons', ['Cece and Schmidt'])
